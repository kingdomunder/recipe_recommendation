  ...
  <!-- 내용 -->
	<div class="w3-container w3-light-grey w3-padding-32 w3-padding-large" id="contact">
    	<div class="w3-content" style="max-width:600px">
     		<h4 class="w3-center"><b>레시피 수정하기 :)</b></h4>
     		<form action="recipe" method="post">
     			<input type="hidden" name="command" value="updateRecipe">
        		<div class="w3-section">
          			<label>음식 이름</label>
          			<input class="w3-input w3-border" type="text" name="foodName" value="${recipeOneSession.foodName}" required>
        		</div>   		
        		<div class="w3-section">
          			<label>메인 재료</label>
          			<input class="w3-input w3-border" type="text" name="ingredient1" value="${ingredientSession[1]}" required>
        		</div>
        		<div class="w3-section">
         			<label>부재료 1</label>
          			<input class="w3-input w3-border" type="text" name="ingredient2" value="${ingredientSession[2]}" required>
        		</div>
        		<div class="w3-section">
         			<label>부재료 2</label>
          			<input class="w3-input w3-border" type="text" name="ingredient3" value="${ingredientSession[3]}">
        		</div>
        		<div class="w3-section">
         			<label>부재료 3</label>
          			<input class="w3-input w3-border" type="text" name="ingredient4" value="${ingredientSession[4]}">
        		</div>
        		<div class="w3-section">
         			<label>부재료 4</label>
          			<input class="w3-input w3-border" type="text" name="ingredient5" value="${ingredientSession[5]}">
        		</div>
        		<div class="w3-section">
         			<label>조리법을 설명해주세요</label>
          			<textarea class="w3-input w3-border" name="direction">${recipeOneSession.direction}</textarea>
        		</div>
