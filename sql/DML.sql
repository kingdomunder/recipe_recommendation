...
insert into recipe values(recipe_id_seq.nextval, 3, '로제파스타', '1. 소금을 1t 넣은 물에 면을 삶는다.'||chr(10)||'2. 기름을 두른 팬에 마늘을 넣고 볶는다.'||chr(10)||'3. 마늘이 노릇해지면 토마토소스와 크림을 넣고 끓인다.'||chr(10)||'4. 면을 넣고 에멀징한다.', null, '27');
